!function (t) {
    ...
    var o = null, i = function () {
        if (null == o) {
            ...
            if ("undefined" != typeof TRACKS_COOKIE_DOMAIN) o = TRACKS_COOKIE_DOMAIN; else for (var n = 1; n <= e.length; ++n) if (t = "." + e.slice(-n).join("."), i = t, r = void 0, r = (new Date).getTime(), document.cookie = encodeURIComponent("tk_tc") + "=" + r + "; domain=" + i + "; path=/;", a("tc") == r) {
                o = t;
                break
            }
            "" != o && (!function (t) {
        ...
        var o = encodeURIComponent("tk_" + t), r = new Date;
        ...
        var e = encodeURIComponent("tk_" + t) + "=", n = e.length, o = document.cookie.split("; "), i = o.length;
        for (1 === i && (i = (o = document.cookie.split(";")).length), i--; i >= 0; i--) if (o[i].substring(0, n) === e) return decodeURIComponent(o[i].substring(n));
        return null
    }
}, function (t, e, n) {
    "use strict";
    ...
    function a(t) {
        var e = [];
        if (window.crypto && window.crypto.getRandomValues) e = new Uint8Array(t), window.crypto.getRandomValues(e); else for (var n = 0; n < t; ++n) e[n] = Math.floor(256 * Math.random());
    ...
    function v() {
        c = void 0, u = null, d = null, [], s = null, f = {}, l = {}, p = {}, m = {}
    }

    v();
    var h = function (t) {
        if (this.a = 1, t && t.length) for (var e = 0; e < t.length; e++) this.push(t[e])
    };
    h.prototype.push = function (t) {
        if (t) if ("object" == i()(t) && t.length) {
            var e = t.splice(0, 1);
            C[e] && C[e].apply(null, t)
        } else "function" == typeof t && t()
    };
    var w = function (t) {
        t._ui || t._ut || T(), S(), t._ui = t._ui || c, t._ut = t._ut || u, d && (t._ul = d);
        var e = new Date;
        t._ts = e.getTime(), t._tz = e.getTimezoneOffset() / 60;
        var n = window.navigator, o = window.screen;
        ...
        t._sx = void 0 !== r ? r : 0, t._sy = void 0 !== a ? a : 0, void 0 !== document.location && (t._dl = document.location.toString()), void 0 !== document.referrer && (t._dr = document.referrer), function t(e, n) {
        ...
        null === s && (s = window.setTimeout(function () {
        ...
        var t = [], e = k("ai"), n = k("aip");
        return n && (t = n.split(",")), e && t.push(e), t
    }, T = function () {
        var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
        if (!c) {
            var e = k("ai");
            e ? (c = e, u = "anon") : t && (c = U(), u = "anon", x("ai", c))
        }
    }, C = {
        storeContext: function (t) {
            ...
            if (e && (d = e), "0" != t && "" != t && null != t && c != t) {
                c = t, u = "wpcom:user_id";
                for (var n = j(), o = 0; o < n.length; o++) w({_en: "_aliasUser", anonId: n[o]});
                var i = k("ai");
                i && w({
            ...
            if (T(!1), c != t) if ("anon" === u || null === u) {
                if ("anon" == u && c) {
                    var e = k("aip");
                    e = e ? e.split(",") : [];
                    for (var n = !1, o = 0; o < e.length; o++) c == e[o] && (n = !0);
                    n || (e.push(c), x("aip", e.join(",")), w({
                        _en: "_aliasUserGeneral",
                        nextUserId: t,
                        nextUserIdType: "anon",
                        prevUserId: c,
            ...
            "_setProperties" !== t && ((e = e || {})._en = t, "string" == typeof n && n.length > 0 && (m[n] || (m[n] = a(18)), e._ui = e._ui || m[n], e._ut = e._ut || "anon"), w(e))
        }, setProperties: function (t) {
            t._en = "_setProperties", w(t)
        }, clearIdentity: function () {
            c = null, d = null, x("ai", "", -1), x("aip", "", -1), T()
        }, signalAliasUserGeneral: function (t, e) {
            T(), w({_en: "_aliasUserGeneral", nextUserId: c, nextUserIdType: u, prevUserId: t, prevUserIdType: e})
        }
    };

    function O() {
        return v(), window._tkq = window._tkq || [], window._tkq.a || (S(), window._tkq = new h(window._tkq)), C
    }
}, , , , , , function (t, e, n) {
    t.exports = n(10)
}, , function (t, e, n) {
    ...
    window.wpcom = window.wpcom || {}, window._tkq = window._tkq || [], window._stq = window._stq || [], Array.prototype.forEach || (Array.prototype.forEach = function (t, e) {
        ...
        var t, e, n, o, r, a, c, u = (n = function (t, e, n) {
            ...
            try {
                ...
                if (window._stq.push(["click", {
                    ...
                    b: void 0 !== t ? t : "0",
                    p: void 0 !== e ? e : "0"
                }]), o) for (var r = new Date, a = r.getTime() + o; !((r = new Date).getTime() > a);) ;
            } catch (t) {
            }
        }, {
            init: function (o, i) {
            ...
            var o = new Image;
            o.src = document.location.protocol + "//pixel.wp.com/" + t + "?" + e + "&rand=" + Math.random(), o.alt = "", "string" == typeof n && document.body && (o.id = n, l(n), document.body.appendChild(o))
        }, l = function (t) {
        ...
        var m, v = function () {
            ...
            view: function (t) {
                t.host = document.location.host, t.ref = document.referrer, f("g.gif", s(t), "wpstats")
            }, extra: function (t) {
        ...
        }) : (m = "unknown", void 0 === document.visibilityState || "visible" !== document.visibilityState && "hidden" !== document.visibilityState && "prerender" !== document.visibilityState && "unloaded" !== document.visibilityState || (m = document.visibilityState), h.extra({"x_stats-initial-visibility": m}), void 0 !== document.hidden && document.hidden ? document.addEventListener("visibilitychange", w) : v()), h
