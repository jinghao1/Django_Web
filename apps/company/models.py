...
class Desc(models.Model):
    ...
    cityName_en = models.CharField(max_length=255, default="NUll", null=True)
    ...
    brief_en = models.CharField(max_length=255)
